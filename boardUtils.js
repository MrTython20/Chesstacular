function setupBoard() {
  ...
  pieces.push(new Piece(21, Color.WHITE, Type.KNIGTH));
  ...
  pieces.push(new Piece(71, Color.WHITE, Type.KNIGTH));
  ...
  pieces.push(new Piece(28, Color.BLACK, Type.KNIGTH));
  ...
  pieces.push(new Piece(78, Color.BLACK, Type.KNIGTH));
